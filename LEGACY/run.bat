...
qemu-system-x86_64 -serial file:serial.log -cpu max -m 4G -smp 1,cores=1,threads=1 -machine q35 -monitor stdio -drive file=os.img,format=raw -device qemu-xhci -device usb-kbd
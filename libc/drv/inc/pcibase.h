...
typedef struct _PCI_DEVICE_CONFIG{
	...
	UINT8	StartPciBusNumber;
	UINT8	EndPciBusNumber;
	UINT32	Reserved;
} PCI_DEVICE_CONFIG;
...
typedef struct _PCI_CONFIGURATION_HEADER {
	...
	UINT8 MinGrant;
	UINT8 MaxLatency;
} PCI_CONFIGURATION_HEADER, *RFPCI_CONFIGURATION_HEADER;

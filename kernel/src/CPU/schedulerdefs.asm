...
; DEFINES
	APIC_ID		equ 0x20
	APIC_EOI equ 0x0B0
	APIC_TIMER_INITIAL_COUNT equ 0x380
	
	BASE_TIMER_TICKS equ 1800
	APIC_PROCESSORID equ 0x20
	TPPL_MAX equ 100
	KRNL_DS equ 0x10
...
; CPU MGMT TABLE
	...
	CPM_CURRENT_THREAD EQU 0xD0
	CPM_SELECTED_THREAD EQU 0xD8
	...
	CPM_HIGH_PRECISION_TIME equ 0x1E0 ; 128 Bit
	CPM_LAST_THREAD_SWITCH_LATENCY equ 0x1F0 ; 128 Bit
	CPM_IRQ_CONTROL_TABLE EQU 0x200

...
enum PRIORITY_CLASS{
    ...
    PRIORITY_CLASS_IDLE = 0x17E,
    PRIORITY_CLASS_LOW = 0x17F,
    PRIORITY_CLASS_BELOW_NORMAL = 0x180,
    PRIORITY_CLASS_NORMAL = 0x181,
    PRIORITY_CLASS_ABOVE_NORMAL = 0x182,
    PRIORITY_CLASS_HIGH = 0x183,
    PRIORITY_CLASS_REALTIME = 0x184,
    PRIORITY_CLASS_MAX = 0X184
};
enum THREAD_PRIORITY{
    THREAD_PRIORITY_MIN = 0x25F,
    THREAD_PRIORITY_IDLE = 0x25F,
    THREAD_PRIORITY_LOW = 0x260,
    THREAD_PRIORITY_BELOW_NORMAL = 0x261,
    THREAD_PRIORITY_NORMAL = 0x262,
    THREAD_PRIORITY_ABOVE_NORMAL = 0x263,
    THREAD_PRIORITY_HIGH = 0x264,
    THREAD_PRIORITY_TIME_CRITICAL = 0x265,
...
enum PRIORITY_CLASS_LIST_INDEX {
    ...
    PRIORITY_CLASS_INDEX_BELOW_NORMAL = 2,
    PRIORITY_CLASS_INDEX_NORMAL = 3,
    PRIORITY_CLASS_INDEX_ABOVE_NORMAL = 4,
    PRIORITY_CLASS_INDEX_HIGH = 5,
    PRIORITY_CLASS_INDEX_REALTIME = 6,

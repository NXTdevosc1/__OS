...
#define SYSTEM_SPACE48_LAPIC            (UINT64)0
#define SYSTEM_SPACE48_PMGRT            (UINT64)0x20000
#define SYSTEM_SPACE48_CPU_MGMT         (UINT64)0x200000
#define SYSTEM_SPACE48_KERNEL           (UINT64)0x100000000000
#define SYSTEM_SPACE48_DEPENDENCIES     (UINT64)0x120000000000
#define SYSTEM_SPACE48_INTERRUPT_CODE   (UINT64)0x140000000000
#define SYSTEM_SPACE48_PROCESSOR_TABLES (UINT64)0x180000000000
#define SYSTEM_SPACE48_IO               (UINT64)0x200000000000
#define SYSTEM_SPACE48_RAM              (UINT64)0x400000000000
#define SYSTEM_SPACE48_MAX              (UINT64)0x7FFFFFFFFFFF
